...
@st.cache_resource 
def load_assets():
    # Make sure these filenames match what you saved in your Jupyter Notebook!
...
try:
    ...
    st.error("🚨 Model files not found! Make sure you run the Jupyter Notebook code to save 'ann_loan_model_lean.pkl' and 'loan_scaler_lean.pkl' in this folder.")
    st.stop()
...
# Create 2 columns for a clean, compact interface
col1, col2 = st.columns(2)

with col1:
    st.markdown("**Personal Information**")
    
    # LabelEncoder mapped alphabetically: Female=0, Joint=1, Male=2, Not Available=3
    ...
    gender = gender_options[gender_selection] # Extracts the number for the model
